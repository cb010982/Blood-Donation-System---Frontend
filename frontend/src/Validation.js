...
export function validateField(fieldName, value) {
    ...
    if (fieldName === InputFieldName.NIC && (value.length !== 12 || !/^\d+$/.test(value))) {
      return "NIC is 12 digits if after 2016, otherwise add 3 zeros to beginning of your NIC if before 2016.";
    }
    if (
...
export function validateForm(forms, currentPage, formValues) { // ONLY APPLIES TO SIGNUP BECAUSE THERE ARE  REQUIRED FEILDS 
